...
export CMAKE_GENERATOR BUILD_JOBS CMAKE_C_COMPILER CMAKE_CXX_COMPILER
export CMAKE_C_COMPILER_LAUNCHER CMAKE_CXX_COMPILER_LAUNCHER CMAKE_C_FLAGS CMAKE_CXX_FLAGS SCCACHE_DIR
export GGML_NATIVE
